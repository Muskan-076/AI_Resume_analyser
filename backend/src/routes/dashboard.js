...
router.get(
    ...
    asyncHandler(async (req, res) => {
        ...
        const latestResumeMeta = resumes[0];

        let latestResume = null;
        let scoreByVersion = new Map();
        ...
        const scoreSeries = versionsWithScores
        ...
        const versionStack = last3.map((v, i, arr) => {
            const prev = arr[i - 1];
