...
router.post(
    ...
    asyncHandler(async (req, res) => {
        ...
        if (!versionId) throw ApiError.badRequest("No versionId provided and resume has no currentVersionId");
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    // chosen bullets swapped in, so we never land with empty sections even if
